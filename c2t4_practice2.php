...
<body>
    ...
    <p><?php echo "Akan tersisa lahan seluas " . number_format($outerStadionArea, 2) . " m<sup>2</sup> yang dapat dimanfaatkan sebagai fasilitas penunjang, namun pemerintah X harus membayar Rp. " . number_format($pricesLandOuterStadion, 2) . " diluar harga lahan stadion." ?></p>
</body>
